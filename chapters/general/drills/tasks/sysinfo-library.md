...
A: True\
Justification: Most information requires interaction with the file system or hardware with the operating system.
...
If argued this way and the answer is "False," points are awarded.
...
The linking modes offer a broader range of applications that can use it, so providing it in both ways is advantageous.
